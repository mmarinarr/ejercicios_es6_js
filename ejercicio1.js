...
const { name, race, age = 10, dangerous = 'yes' } = animalFunction;
console.log(age, dangerous)

/*1.4 En base al siguiente javascript, usa destructuring para crear las variables name y itv con sus respectivos valores. Posteriormente crea 
